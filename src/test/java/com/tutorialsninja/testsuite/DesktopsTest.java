 ...
 * 2.7	Verify the Text "HP LP3065" 2.8 Select Delivery Date "2023-11-27"
...
public class DesktopsTest extends BaseTest {
    ...
    public void verifyProductArrangeInAlphabeticalOrder() throws InterruptedException {
        ...
        // * 1.3	Select Sort By position "Name: Z to A"
        List<WebElement> allList = desktopsPage.getAllProductTitleOnPage();
        ...
        allList = desktopsPage.getAllProductTitleOnPage();
        for (WebElement list : allList) {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        Thread.sleep(3000);
        hplp3065ProductPage.datePickerForDelivery("2025-11-27");
